...
const RULES = {
  ...
  late:       { from: { h:8,  m:1 }, to: { h:15, m:59 } },   // 8:01 ص - 11:59 ص تأخير دخول مع خصم
  earlyLeave: { from: { h:16, m:0 }, to: { h:17, m:59 } },   // 12:00 م - 1:59 م خروج مبكر مع خصم
  checkOut:   { from: { h:18, m:0 }, to: { h:23, m:59 } },   // 2:00 م - 11:59 م
